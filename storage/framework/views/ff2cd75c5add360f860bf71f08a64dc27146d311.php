...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Windows Scheduled Job</title>
        ...
        <style>
            ...
            Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;line-height:1.5}*,
            :after,
            ...
            .button1 {background-color: #f5f0f0;}
            .button2 {background-color: #f5f0f0;}
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <h1>Emory University Windows Scheduled Job</h1> <br>
                ...
                <div class="container">
                    <div class="center">
                            <form action="functioncalling.php">
                                <input type="submit" name="insert" value="insert" class = "button button1" onclick="insert()" />
                                <input type="submit" name="select" value="select" class = "button button2" onclick="select()" />
                            </form>
